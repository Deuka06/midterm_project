...
void main(List<String> arguments) async {
  ...
  final cityApiClient = getCityClass();
  final currentWeather = await cityApiClient.getCityName(cityName);
  print(currentWeather);

  // Получение текущей погоды
  // try {
  //   final currentWeather = await weatherApiClient.getCityName(cityName);
